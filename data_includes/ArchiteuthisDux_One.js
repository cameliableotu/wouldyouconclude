...
['shared-intro', "Question", {q:"In <i>Linda doesn't have to shout. Everyone can hear her.</i> the sentence <i>Linda doesn't have to shout</i> means",as: [['s', 'It is necessary that Linda does not shout.'], ['k','It is not necessary that Linda shouts.']]},
...
['shared-intro', "Question", {q:"In ‘Don't tell lies! Your friend will be upset with you’.</i>, the sentence ‘Don't tell lies!’</i> means",as: [['s', 'It is necessary that you do not tell lies.'], ['k','It is not necessary that you tell lies.']]},
...
['shared-intro', "Question", {q:"In ‘Don't be tall! There are enough tall people in the room.’ the sentence ‘Don't be tall!’ means ",as: [['s', 'It is necessary that you are tall.'], ['k', 'It is not necessary that you are tall.']]},
...
[["MODALITYNEGATION-notnecessary",1], "Question", {q:"In ‘You mustn't worry. The woman will give you the money.’, ‘You mustn't worry’ means",as: [['s','It is neccessary that you do not worry.'],['k','It is not necessary that you worry.']]},
...
[["MODALITYNEGATION-notnecessary",2],  "Question",{q:"In ‘He mustn't panic. The teacher will give the class an easy test.’, ‘He mustn't panic’ means",as: [['s','It is necessary that he does not panic.'],['k','It is not necessary that he panics.']]}, 
                                       "AcceptabilityJudgment", {s: "How acceptable do you think ‘He mustn't panic’ is in the context ‘He mustn't panic. The teacher will give the class an easy test.’</i>?"}],
...
[["MODALITYNEGATION-notnecessary",4],  "Question", {q:"In ‘You mustn't be angry. The man will reward you for your efforts.’, ‘You mustn't be angry.’ means",as: [['s','It is necessary that you are not angry.'],['k','It is not necessary that you are angry.']]}, 
                                       "AcceptabilityJudgment", {s: "How acceptable do you think ‘You mustn't be angry.’ is in the context ‘You mustn't be angry. The man will reward you for your efforts.’</i>?"}],
...
[["MODALITYNEGATION-notnecessary",5], "Question", {q:"In ‘Tom mustn't eat the bread. It won't go stale by tomorrow.’, ‘Tom mustn't eat the bread.’ means",as: [['s','It is necessary that Tom does not eat the bread.'],['k','It is not necessary that Tom eats the bread.']]},
...
[["MODALITYNEGATION-necessarynot",5], "Question", {q:"In ‘Tom mustn't eat the bread. They have visitors coming over.’, ‘Tom mustn't eat the bread.’ means",as: [['s','It is necessary that Tom does not eat the bread.'],['k','It is not necessary that Tom eats the bread.']]},
...
[["MODALITYNEGATION-notnecessary",6], "Question", {q:"In ‘You mustn't do office work at home. You managed to get it done already.’, ‘You mustn't do office work.’ means",as: [['s','It is necessary that you do not do office work.'],['k','It is not necessary that you do office work.']]},
...
[["MODALITYNEGATION-necessarynot",6], "Question", {q:"In ‘You mustn't do  office work at home. Your wife and kids will be upset.’ ,‘You mustn't do office work.’ means",as: [['s','It is necessary that you do not do office work.'],['k','It is not necessary that you do office work.']]},
                                      "AcceptabilityJudgment", {s: "How acceptable do you think ‘You mustn't do office work at home.’ is in the context ‘You mustn't do  office work at home. Your wife and kids will be upset.’</i>?"}],
[["MODALITYNEGATION-notnecessary",7], "Question", {q:"In ‘Linda mustn't speak German. All the German people in the office speak English.’, ‘Linda mustn't speak German.’ means",as: [['s','It is necessary that you do not speak German.'],['k','It is not necessary that you speak German.']]},
                                       "AcceptabilityJudgment", {s: "How acceptable do you think ‘Linda mustn't speak German.’is in the context ‘Linda mustn't speak German. All the German people in the office speak English.’</i>?"}],
[["MODALITYNEGATION-necessarynot",7], "Question", {q:"In ‘Linda mustn't speak German. Our guests only speak English.’, ‘Linda mustn't speak German.’ means",as: [['s','It is necessary that you do not speak German.'],['k','It is not necessary that you speak German.']]},
...
[["filler-should",11],  "Question", {q:"In ‘Tim shouldn't cook rice. His girlfriend does not like it.’, ‘Tim shouldn't cook rice.’ means",as: [['s','It is necessary that Tim does not cook rice.'],['k','It is not necessary that Tim cooks rice.']]},
...
[["filler-need",13], "Question", {q:"In ‘Tom needn't be offended. The woman didn't want to insult him at all.’ means",as: [['s','It is necessary that Tom is not offended.'],['k','It is not necessary that Tom is offended.']]},
...
[["filler-should",17],"Question", {q:"In ‘Tom shouldn't be happy. The school will give him a lot of money.’, ‘Tom shouldn't be happy.’ means",as: [['s','It is necessary that Tom is not happy.'],['k','It is not necessary that Mary is happy.']]},
...
[["filler-should",18], "Question", {q:"In ‘You shouldn't be amazed. Your wife won the biggest film prize ever.’, ‘You shouldn't be amazed.’ means",as: [['s','It is necessary that you are not amazed.'],['k','It is not necessary that you are amaze.']]},
...
[["filler-should",19],  "Question", {q:"In ‘Linda shouldn’t help Mary. Mary is feeling very lost.’, ‘Linda shouldn’t help Mary.’ means",as: [['s','It is necessary that Linda does not help Mary.'],['k','It is not necessary that Tim cooks rice.']]},
...
[["filler-should",20],  "Question", {q:"In  ‘You shouldn't talk kindly to yourself. You will end up with depression.’, 'You shouldn't talk kindly to yourself.' means",as: [['s','It is necessary that you do not talk kindly to yourself.'],['k','It is not necessary that you talk kindly to yourself yourself.']]},
...
[["filler-need", 21], "Question", {q:"In ‘Bill needn't be excited. The woman invited him to his favorite films.’ means",as: [['s','It is necessary that Bob is not excited .'],['k','It is not necessary that Bob is excited.']]},
                      "AcceptabilityJudgment", {s: "How acceptable do you think ‘Bob needn't be mad.’ is in the context ‘Bob needn't be mad. The woman wanted to hurt his feelings.’?"}],
...
[["filler-need",23], "Question", {q:"In ‘Sarah needn't take care of the sick. They are in great suffering.’, ‘Sarah needn't take care of the sick.’ means",as: [['s','It is necessary that Sarah does not take care of the sick.'],['k','It is not necessary that Sophie takes care of the sick.']]},
...
[["filler-need",24], "Question", {q:"In ‘You needn't sweep the floor. It is very dirty.’, ‘You needn't sweep the kitchen.’ means",as: [['s','It is necessary that you do not sweep the floor.'],['k','It is not necessary that you sweep the floor.']]},

...
[["MODALITYNEGATION-notnecessary",1], "Question", {q:"In ‘You mustn't worry. The woman will give you the money.’, ‘You mustn't worry’ means",as: [['s','It is necessary that you do not worry.'],['k','You are not obliged to worry.']]},
...
[["MODALITYNEGATION-necessarynot",1],  "Question", {q:"In ‘You mustn't worry. You will get sick otherwise’, ‘You mustn't worry’ means",as: [['s','It is necessary that you do not worry.'],['k','You are not obliged to worry.']]},
...
[["MODALITYNEGATION-notnecessary",2],  "Question",{q:"In ‘He mustn't panic. The teacher will give the class an easy test.’, ‘He mustn't panic’ means",as: [['s','It is necessary that he does not panic.'],['k','He is not obliged to panic.']]}, 
...
[["MODALITYNEGATION-notnecessary",2], "Question", {q:"In ‘He mustn't panic. The bears will attack him otherwise.’, ‘He mustn't panic’ means",as: [['s','It is necessary that he does not panic.'],['k','He is not obliged to panic.']]}, 
...
[["MODALITYNEGATION-notnecessary",3], "Question", {q:"In ‘She mustn't be sad. Her mom will find the doll.’, ‘She mustn't be sad.’ means",as: [['s','It is necessary that she is not sad.'],['k','She is not obliged to be sad.']]}, 
...
[["MODALITYNEGATION-necessarynot",3],  "Question", {q:"In ‘She mustn't be sad. She will ruin the party otherwise.’, ‘She mustn't be sad.’ means", as: [['s','It is necessary that she is not sad.'],['k','She is not obliged to be sad.']]},
...
[["MODALITYNEGATION-notnecessary",4],  "Question", {q:"In ‘You mustn't be angry. The man will reward you for your efforts.’, ‘You mustn't be angry.’ means",as: [['s','It is necessary that you are not angry.'],['k','You are not obliged to be angry.']]}, 
...
[["MODALITYNEGATION-necessarynot",4], "Question", {q:"In ‘You mustn't be angry. Your mother will punish you otherwise.’,‘You mustn't be angry.’means",as: [['s','It is necessary that you are not angry.'],['k','You are not obliged to be angry']]},
...
[["MODALITYNEGATION-notnecessary",5], "Question", {q:"In ‘Tom mustn't eat the bread. It won't go stale by tomorrow.’, ‘Tom mustn't eat the bread.’ means",as: [['s','It is necessary that Tom does not the bread.'],['k','Tom is not obliged to eat the bread.']]},
...
[["MODALITYNEGATION-necessarynot",5], "Question", {q:"In ‘Tom mustn't eat the bread. They have visitors coming over.’, ‘Tom mustn't eat the bread.’ means",as: [['s','It is necessary that Tom does not the bread.'],['k','Tom is not obliged to eat the bread.']]},
...
[["MODALITYNEGATION-notnecessary",6], "Question", {q:"In ‘You mustn't do office work. Bill managed to get it done already.’, ‘You mustn't do office work .’ means",as: [['s','It is necessary that you do not do office work.'],['k','You are not obliged to do office work at home.']]},
...
[["MODALITYNEGATION-necessarynot",6], "Question", {q:"In ‘You mustn't do  office work. Your wife and kids will be upset.’ ,‘You mustn't do office work.’ means",as: [['s','It is necessary that you do not do office work.'],['k','You are not obliged to do office work at home.']]},
...
[["MODALITYNEGATION-notnecessary",7], "Question", {q:"In ‘Linda mustn't speak German. All the German people in the office speak English.’, ‘Linda mustn't speak German.’ means",as: [['s','It is necessary that Linda does not speak German.'],['k','Linda is not obliged to speak German.']]},
...
[["MODALITYNEGATION-necessarynot",7], "Question", {q:"In ‘Linda mustn't speak German. Our guests only speak English.’, ‘Linda mustn't speak German.’ means",as: [['s','It is necessary that you speak German speak German.'],['k','You are not obliged to speak German.']]},
...
[["MODALITYNEGATION-notnecessary",8], "Question", {q:"In ‘You mustn't drink alcohol. You are already in good spirits.’,‘You mustn't drink alcohol.’ means",as: [['s','It is necessary that you do not drink alcohol.'],['k','You are not obliged to drink alcohol.']]},
...
[["MODALITYNEGATION-necessarynot",8], "Question", {q:"In ‘You mustn't drink alcohol. It will make you feel sick.’,‘You mustn't drink alcohol.’ means",as: [['s','It is necessary that you do not drink alcohol.'],['k','You are not obliged to drink alcohol.']]},
...
//// Fillers
[["filler-should",9],"Question", {q:"In ‘Mary shouldn't be upset. Her father will give her a new car.’, ‘Mary shouldn't be upset.’ means",as: [['s','It is necessary that Mary is not upset.'],['k','Mary is not obliged to be upset.']]},
...
[["filler-should",10], "Question", {q:"In ‘You shouldn't be annoyed. Your wife will cook dinner for you.’, ‘You shouldn't be annoyed.’ means",as: [['s','It is necessary that you are not annoyed.'],['k','You are not obliged to be annoyed.']]},
...
[["filler-should",11],  "Question", {q:"In ‘Tim shouldn't cook rice. His girlfriend does not like it.’, ‘Tim shouldn't cook rice.’ means",as: [['s','It is necessary that Tim does not cook rice.'],['k','Tim is not obliged to cook rice.']]},
...
[["filler-should",12],  "Question", {q:"In  ‘You shouldn't write the first draft yourself. Linda is the first author.’, 'You shouldn't write the first draft yourself.' means",as: [['s','It is necessary that you do not write the first draft yourself.'],['k','You are not obliged to write the first draft yourself.']]},
...
[["filler-need",13], "Question", {q:"In ‘Tom needn't be offended. The woman didn't want to insult him at all.’, 'Tom needn't be offended.' means",as: [['s','It is necessary Tom is not offended.'],['k','Tom is not obliged to be offended.']]},
...
[["filler-need",14], "Question", {q:"In  ‘You needn't be outraged. The professor is simply joking a bit.’, ‘You needn't be outraged. ’ means",as: [['s','It is necessary that you are not outraged.'],['k','You are not obliged to be outraged.']]},
...
[["filler-need",15], "Question", {q:"In ‘Sophie needn't tidy the room today. It still looks quite great.’, ‘Sophie needn't tidy the room today.’ means",as: [['s','It is necessary that Sophie does not tidy the room.'],['k','Sophie is not obliged to tidy the room.']]},
...
[["filler-need",16], "Question", {q:"In ‘You needn't draw all the materials yourself. You can hire a designer.’, ‘You needn't draw all the materials yourself.’ means",as: [['s','It is necessary that you do not draw all the materials yourself.'],['k','You are not obliged to draw all the materials yourself.']]},
...
[["filler-should",17],"Question", {q:"In ‘Tom shouldn't be happy. The school will give him a lot of money.’, ‘Tom shouldn't be happy.’ means",as: [['s','It is necessary that Tom is not happy.'],['k','Tom is not obliged to be happy.']]},
...
[["filler-should",18], "Question", {q:"In ‘You shouldn't be amazed. Your wife won the biggest film prize ever.’, ‘You shouldn't be amazed.’ means",as: [['s','It is necessary that you are not amazed.'],['k','You are not obliged to be amazed.']]},
...
[["filler-should",19],  "Question", {q:"In ‘Linda shouldn’t help Mary. Mary is feeling very lost.’, ‘Linda shouldn’t help Mary.’ means",as: [['s','It is necessary that Linda does not help Mary.'],['k','Linda is not obliged to help Mary.']]},
...
[["filler-should",20],  "Question", {q:"In  ‘You shouldn't talk kindly to yourself. You will end up with depression.’, 'You shouldn't talk kindly to yourself.' means",as: [['s','It is necessary that you do not talk kindly to yourself.'],['k','You are not obliged to talk kindly to yourself.']]},
...
[["filler-need", 21], "Question", {q:"In ‘Bill needn't be excited. The woman invited him to his favorite film.’, ‘Bill needn't be excited.’ means",as: [['s','It is not necessary that Bill is excited.'],['k','Bill is not obliged to be excited.']]},
...
[["filler-need",22], "Question", {q:"In  ‘You needn't be pleased. Your husband gave you a wonderful gift.’, ‘You needn't be pleased. ’ means",as: [['s','It is not necessary that you are pleased.'],['k','You are not obliged to be pleased.']]},
...
[["filler-need",23], "Question", {q:"In ‘Sarah needn't take care of the sick. They are in great suffering.’, ‘Sarah needn't take care of the sick.’ means",as: [['s','It is not necessary that Sarah takes care of the sick.'],['k','Sarah is not obliged to take care of the sick.']]},
...
[["filler-need",24], "Question", {q:"In ‘You needn't sweep the floor. It is very dirty.’, ‘You needn't sweep the floor.’ means",as: [['s','It is not necessary that you sweep the floor.'],['k','You are not obliged to sweep the floor.']]},
